#!/usr/bin/env python3
"""
Verify commission calculations with REAL data from Excel CSV
"""
...
# REAL Disposition data from Excel
dispoData = {
    'Alec Prieto': [
        {'gp': 18370, 'ff': True},
        {'gp': 15000, 'ff': False},
...
# REAL Acquisition data from Excel
acqData = {
    'Andrew Caceres': [
        {'gp': 22125, 'ff': True},
        {'gp': 15000, 'ff': False},
...
print("=" * 80)
print("DISPOSITION AGENTS - REAL DATA CALCULATIONS")
print("=" * 80)
...
print("\n" + "=" * 80)
print("ACQUISITION AGENTS - REAL DATA CALCULATIONS")
print("=" * 80)
...
print("SUMMARY")
print("=" * 80)
print(f"Agent Commissions: ${acq_total_commission + dispo_total_commission:,.2f}")
print(f"  - Acq Agents:    ${acq_total_commission:,.2f}")
print(f"  - Dispo Agents:  ${dispo_total_commission:,.2f}")
print(f"\nManager Commissions (from v2): $40,969.81")
print(f"TOTAL EXPECTED: ${acq_total_commission + dispo_total_commission + 40969.81:,.2f}")
