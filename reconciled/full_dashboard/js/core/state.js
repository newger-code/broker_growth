...
const AppState = {
  ...
  /**
   * Get acquisition agent records
   */
  getAcquisitionAgents() {
    return this.data?.acquisition_agents || [];
  },

  /**
   * Get disposition agent records
   */
  getDispositionAgents() {
    return this.data?.disposition_agents || [];
  },
